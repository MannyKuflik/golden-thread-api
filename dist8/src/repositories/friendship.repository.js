...
let FriendshipRepository = class FriendshipRepository extends repository_1.DefaultCrudRepository {
    constructor(datasource) {
        super(models_1.Friendship, datasource);
        this.datasource = datasource;
    }
};
FriendshipRepository = __decorate([
